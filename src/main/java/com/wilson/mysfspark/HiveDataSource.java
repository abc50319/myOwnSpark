...
public class HiveDataSource {
    ...
    public static void main(String[] args) {
        ...
        hiveContext.sql("DROP TABLE IF EXISTS lsm_student_infos");
        // 判断student_infos表是否不存在，如果不存在，则创建该表
        hiveContext.sql("CREATE TABLE IF NOT EXISTS lsm_student_infos (name STRING, age INT)");
        ...
        Dataset<Row> rowDataset = hiveContext.sql("SELECT si.name, si.age, ss.score "
        ...
        //rowDataset.saveAsTable("good_student_infos");
